...
@section('content_fluid')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form class="row g-3" method="POST" action="{{ route('admin.cancellation.update', ['id' => $dep->id]) }}">
                @csrf
                <div class="col-md-12">
                    <label for="inputTitle" class="form-label">Title</label>
                    <input type="text" class="form-control" name="title" id="inputTitle" value="{{ $dep->title }}">
                    @if ($errors->has('title'))
                ...
                <div class="col-md-12">
                    <div class="form-floating">
                        <textarea class="form-control" placeholder="Leave a comment here" name="content" id="floatingTextarea">{{ $dep->content }}</textarea>
