...
@section('content_fluid')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form class="row g-3" method="POST" action="{{ route('admin.role.update', ['id' => $dep->id]) }}">
                @csrf
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" name="salary" id="inputSalary" value="{{ $dep->salary }}">
