...
@section('content_fluid')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form class="row g-3" method="POST" action="{{ route('admin.foodtype.update', ['id' => $foodtype->id]) }}" enctype="multipart/form-data">
                @csrf
                <div class="col-md-12">
                    <label for="inputName" class="form-label">Name</label>
                    <input type="text" class="form-control" name="name" id="inputName" value="{{ $foodtype->name }}">
                    @if ($errors->has('name'))
                ...
                <div class="col-md-6">
                    <img id="image_preview" style="width: 350px ; height:200px"
                        src="{{Storage::url($foodtype->image)}}"
                        alt="User">
                </div>
                <div class="col-12">
